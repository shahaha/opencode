...
import { parseLinkHeader } from "../../src/util/link-header"
...
describe("util.parseLinkHeader", () => {
  ...
  test("returns empty object for undefined-ish input", () => {
    expect(parseLinkHeader(undefined as unknown as string)).toEqual({})
  })
