...
export function Session() {
  ...
  const [permissionExpanded, setPermissionExpanded] = createSignal(false)
    ...
    >
      <box flexDirection="row">
        <box flexGrow={1} paddingBottom={1} paddingTop={1} paddingLeft={2} paddingRight={2} gap={1}>
          <Show when={session()}>
            <Show when={!permissionExpanded() && (!sidebarVisible() || !wide())}>
              <Header />
            </Show>
            <Show when={!permissionExpanded()}>
              <scrollbox
                ref={(r) => (scroll = r)}
                viewportOptions={{
            ...
            <box flexShrink={0}>
              <Show when={permissions().length > 0}>
                <PermissionPrompt request={permissions()[0]} onExpandedChange={setPermissionExpanded} />
              </Show>
