...
export namespace Flag {
  ...
  export const OPENCODE_EXPERIMENTAL_ICON_DISCOVERY =
    flag("OPENCODE_EXPERIMENTAL_ICON_DISCOVERY") ?? OPENCODE_EXPERIMENTAL
  export const OPENCODE_EXPERIMENTAL_DISABLE_COPY_ON_SELECT = truthy("OPENCODE_EXPERIMENTAL_DISABLE_COPY_ON_SELECT")
  export const OPENCODE_ENABLE_EXA =
    flag("OPENCODE_ENABLE_EXA") ?? flag("OPENCODE_EXPERIMENTAL_EXA") ?? OPENCODE_EXPERIMENTAL
  export const OPENCODE_EXPERIMENTAL_BASH_DEFAULT_TIMEOUT_MS = number("OPENCODE_EXPERIMENTAL_BASH_DEFAULT_TIMEOUT_MS")
  export const OPENCODE_EXPERIMENTAL_OUTPUT_TOKEN_MAX = number("OPENCODE_EXPERIMENTAL_OUTPUT_TOKEN_MAX")
  export const OPENCODE_EXPERIMENTAL_OXFMT = flag("OPENCODE_EXPERIMENTAL_OXFMT") ?? OPENCODE_EXPERIMENTAL
  export const OPENCODE_EXPERIMENTAL_LSP_TY = truthy("OPENCODE_EXPERIMENTAL_LSP_TY")
  export const OPENCODE_EXPERIMENTAL_LSP_TOOL = flag("OPENCODE_EXPERIMENTAL_LSP_TOOL") ?? OPENCODE_EXPERIMENTAL
  export const OPENCODE_DISABLE_FILETIME_CHECK = truthy("OPENCODE_DISABLE_FILETIME_CHECK")
  export const OPENCODE_EXPERIMENTAL_PLAN_MODE = flag("OPENCODE_EXPERIMENTAL_PLAN_MODE") ?? OPENCODE_EXPERIMENTAL
