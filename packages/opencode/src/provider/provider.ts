...
export namespace Provider {
  ...
  // Scitely AI - Built-in Provider Definition
  const SCITELY_PROVIDER: ModelsDev.Provider = {
    id: "scitely",
    name: "Scitely AI",
    api: "https://api.scitely.com/v1",
  ...
  const state = Instance.state(async () => {
    ...
    // Add Scitely AI as built-in provider if not already in models.dev
    if (!database["scitely"]) {
      database["scitely"] = fromModelsDevProvider(SCITELY_PROVIDER)
    }
