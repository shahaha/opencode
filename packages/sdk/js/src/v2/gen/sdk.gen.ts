...
export class Dialog extends HeyApiClient {
  /**
   * Reply to dialog
   *
   * Provide a response to a dialog request from a plugin.
   */
  public reply<ThrowOnError extends boolean = false>(
    parameters: {
      dialogID: string
    ...
    const params = buildClientParams(
      ...
      [
        {
          args: [
            { in: "path", key: "dialogID" },
            { in: "query", key: "directory" },
            { in: "body", key: "value" },
            { in: "body", key: "dismissed" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).post<DialogReplyResponses, DialogReplyErrors, ThrowOnError>({
...
export class OpencodeClient extends HeyApiClient {
  ...
  dialog = new Dialog({ client: this.client })
