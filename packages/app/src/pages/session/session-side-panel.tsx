  ...
  return (
      <aside
        ...
        classList={{
          ...
          "border-l border-border-weak-base": props.open,
          "flex-1": props.reviewOpen,
          "shrink-0": !props.reviewOpen,
          "transition-[width] duration-200 ease-out": props.animations && !props.reviewOpen && !fileTreeResizing(),
        }}
        style={{ width: props.reviewOpen ? undefined : props.open ? `${props.layout.fileTree.width()}px` : "0px" }}
