export const dict = {
  ...
  "dialog.server.credentials.title": "Inserir credenciais",
  "dialog.server.credentials.description": "Conectar a {{url}}",
  "dialog.server.credentials.error.required": "Usuário e senha são obrigatórios",
  "dialog.server.credentials.error.invalid": "Usuário ou senha inválidos",
  ...
  "dialog.server.status.authRequired": "Autenticação necessária",
  "dialog.server.status.invalidCredentials": "Credenciais inválidas",
