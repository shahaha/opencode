export const dict = {
  ...
  "dialog.provider.tag.connected": "Connected",
  "dialog.provider.action.disconnect": "Disconnect",
  "dialog.provider.action.reconnect": "Reconnect",
  "dialog.provider.toast.disconnected.title": "Disconnected from {{provider}}",
  "dialog.provider.toast.disconnected.description": "Your {{provider}} credentials have been removed.",
