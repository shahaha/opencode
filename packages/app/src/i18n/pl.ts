export const dict = {
  ...
  "context.tab.tools": "Narzędzia",

  "context.tools.title": "Użycie narzędzi",
  "context.tools.details": "Rozbicie narzędzi",
  "context.tools.history": "Historia wywołań",
  "context.tools.empty": "W tej sesji nie użyto żadnych narzędzi",
