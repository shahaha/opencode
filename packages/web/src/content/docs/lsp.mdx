...
| basedpyright | .py, .pyi                                            | Auto-installs for Python projects                            |
...
:::tip
OpenCode uses **basedpyright** as the Python LSP server. Basedpyright is an actively maintained fork of pyright with additional features including inlay hints, semantic highlighting, and stricter type checking. It's fully compatible with `pyrightconfig.json` configuration files.
:::
