...
These paths are relative to the location where opencode runs. To define instructions in the global config (which will always be used), you should use absolute paths in this array.
