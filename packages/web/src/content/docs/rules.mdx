...
You can also place rules in `.opencode/AGENTS.md`. These are loaded in addition to your normal project rules.
...
For local rules, opencode prefers `AGENTS.md` over `CLAUDE.md` (and `CONTEXT.md`), but still loads any `.opencode/AGENTS.md` files it finds. For global rules, `~/.config/opencode/AGENTS.md` takes precedence over `~/.claude/CLAUDE.md`.
