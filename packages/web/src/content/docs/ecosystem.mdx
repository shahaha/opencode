...
| [opencode-plugin-preload-skills](https://github.com/juhas96/opencode-plugin-preload-skills)               | Intelligently loads skills based on context — file types, directory patterns, agent type          |
