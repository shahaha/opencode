...
| [VSCode OpenCode Zen Chat Provider](https://github.com/wienans/vsc-opencode-zen-chat-provider) | VS Code Extension for OpenCode Zen to use in the build in Agent  |
