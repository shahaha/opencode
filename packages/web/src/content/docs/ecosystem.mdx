...
| [opencode-fast-apply](https://github.com/tickernelz/opencode-fast-apply)                           | OpenCode plugin for Fast Apply code editing with OpenAI-compatible APIs (LM Studio, Ollama)    |
