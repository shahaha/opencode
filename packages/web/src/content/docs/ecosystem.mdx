...
| [opencode-flowchestra](https://github.com/Sheetaa/flowchestra/tree/main/packages/opencode-flowchestra) | an OpenCode primary agent that executes multi-agent workflows defined in Markdown files with Mermaid Flowcharts. |
