...
| [@happycastle/opencode-openmemory](https://github.com/happycastle114/opencode-openmemory)          | Local-first, privacy-focused persistent memory for OpenCode agents using OpenMemory.           |
