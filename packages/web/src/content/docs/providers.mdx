...
Scitely AI provides affordable access to powerful AI models including Qwen, DeepSeek, Kimi, and more.

1. Head over to [Scitely](https://scitely.com) and create an account to get your API key.

2. Run the `/connect` command and search for **Scitely**.

   ```txt
   /connect
   ```

3. Enter your Scitely API key.
...
Scitely offers a variety of models:

- **Qwen3 Coder Plus** - Optimized for coding tasks
- **Qwen3 Max** - Large-scale general purpose model
- **DeepSeek V3/R1** - High-performance reasoning models
- **Kimi K2** - Efficient conversational model
