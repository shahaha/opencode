...
2. Select your GitHub deployment type.
...
3. Navigate to [github.com/login/device](https://github.com/login/device) and enter the code.
...
4. Now run the `/models` command to select the model you want.
...
For organizations using GitHub Enterprise (data residency or self-hosted):

1. Run `/connect` and select **GitHub Copilot**.

2. Select **GitHub Enterprise** as the deployment type.

3. Enter your GitHub Enterprise URL or domain.
...
4. Navigate to your Enterprise device login page and enter the code.
   ...
   │
   │ Enter code: C30A-4C07
   │
   └ Waiting for authorization...
   ```

5. Run `/models` to select the model you want.
