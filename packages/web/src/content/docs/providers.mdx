...
Nous Research provides access to the Hermes and DeepHermes family of models, offering powerful reasoning capabilities through an OpenAI-compatible API.

1. Head over to the [Nous Research inference platform](https://inference-api.nousresearch.com/), create an account, and generate an API key.

2. Run the `/connect` command and search for **Nous Research**.

   ```txt
   /connect
   ```

3. Enter your Nous Research API key.
...
4. Run the `/models` command to select a model like _Hermes 4.3 36B_ or _Hermes 4 405B_.
...
- **Hermes 4.3 36B** - Latest Hermes model with 128K context
- **Hermes 4 405B** - Largest Hermes 4 model with 128K context
- **Hermes 4 70B** - Mid-size Hermes 4 model with 128K context
- **DeepHermes 3 Mistral 24B (Preview)** - Reasoning-focused model
- **DeepHermes 3 Llama 3 8B (Preview)** - Compact reasoning model
- **Hermes 3 Llama 3.1 405B** - Previous generation flagship
- **Hermes 3 Llama 3.1 70B** - Previous generation mid-size
