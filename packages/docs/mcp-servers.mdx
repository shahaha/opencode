...
```json opencode.json highlight={15}
{
  "$schema": "https://opencode.ai/config.json",
  "mcp": {
    "my-local-mcp-server": {
...
```json opencode.json highlight={14}
{
  "$schema": "https://opencode.ai/config.json",
  "mcp": {
    "my-mcp-foo": {
...
2. In your [agent config](/agents#tools) enable the MCP server as a tool.

```json opencode.json highlight={11, 14-18}
{
  "$schema": "https://opencode.ai/config.json",
  "mcp": {
    "my-mcp": {
...
```json opencode.json highlight={4-7}
{
  "$schema": "https://opencode.ai/config.json",
  "mcp": {
    "context7": {
...
```json opencode.json highlight={7-9}
{
  "$schema": "https://opencode.ai/config.json",
  "mcp": {
    "context7": {
