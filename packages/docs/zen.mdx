...
The [model id](/config#models) in your OpenCode config
...
You might notice _Claude Haiku 3.5_ in your usage history. This is a [low cost model](/config#models) that's used to generate the titles of your sessions.
...
<a href="mailto:contact@anoma.ly">Contact us</a> if you have any questions.
