...
```markdown ~/.config/opencode/agent/review.md expandable
---
...
If you don’t specify a model, primary agents use the [model globally configured](/config#models) while subagents will use the model of the primary agent that invoked the subagent.
</Tip>
...
```json opencode.json highlight={3-5,8-10}
{
  "$schema": "https://opencode.ai/config.json",
  "permission": {
    "edit": "deny"
...
```json opencode.json highlight={7}
{
  "$schema": "https://opencode.ai/config.json",
  "agent": {
    "build": {
...
```json opencode.json highlight={8}
{
  "$schema": "https://opencode.ai/config.json",
  "agent": {
    "build": {
...
```json opencode.json highlight={6,7}
{
  "agent": {
    "deep-thinker": {
...
```markdown ~/.config/opencode/agent/docs-writer.md expandable
---
...
```markdown ~/.config/opencode/agent/security-auditor.md expandable
---
