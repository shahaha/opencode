...
```json opencode.json highlight={4-12}
{
...
```markdown ~/.config/opencode/command/test.md
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md .opencode/command/component.md
---
...
```md .opencode/command/create-file.md
---
...
```md .opencode/command/analyze-coverage.md
---
...
```md .opencode/command/review-changes.md
---
...
```md .opencode/command/review-component.md
---
