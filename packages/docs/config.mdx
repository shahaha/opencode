...
<CardGroup cols={1}>
<Card title="Learn more about using the TUI here" href="/tui"  icon="angles-right" horizontal/>
</CardGroup>
...
```
<CardGroup cols={1}>
<Card title="Learn more about tools here" href="/tools"  icon="angles-right" horizontal/>
</CardGroup>
...
You can also configure [local models](/models#local). 

<CardGroup cols={1}>
<Card title="Learn more" href="/models"  icon="angles-right" horizontal/>
</CardGroup>
...
<CardGroup cols={1}>
<Card title="Learn more here" href="/themes"  icon="angles-right" horizontal/>
</CardGroup>
...
You can also define agents using markdown files in `~/.config/opencode/agent/` or `.opencode/agent/`. 

<CardGroup cols={1}>
<Card title="Learn more here" href="/agents"  icon="angles-right" horizontal/>
</CardGroup>

### Sharing

You can configure the [share](/share) feature through the `share` option.
...
You can also define commands using markdown files in `~/.config/opencode/command/` or `.opencode/command/`. 

<CardGroup cols={1}>
<Card title="Learn more here" href="/commands"  icon="angles-right" horizontal/>
</CardGroup>
...
<CardGroup cols={1}>
<Card title="Learn more here" href="/keybinds"  icon="angles-right" horizontal/>
</CardGroup>
...
<CardGroup cols={1}>
<Card title="Learn more about formatters here" href="/formatters"  icon="angles-right" horizontal/>
</CardGroup>
...
<CardGroup cols={1}>
<Card title="Learn more about permissions here" href="/permissions"  icon="angles-right" horizontal/>
</CardGroup>
...
<CardGroup cols={1}>
<Card title="Learn more here" href="/mcp-servers"  icon="angles-right" horizontal/>
</CardGroup>
...
<CardGroup cols={1}>
<Card title="Learn more about rules here" href="/rules"  icon="angles-right" horizontal/>
</CardGroup>
